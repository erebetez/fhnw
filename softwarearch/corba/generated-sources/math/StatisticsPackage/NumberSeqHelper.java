...
/**
* math/StatisticsPackage/NumberSeqHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Statistics.idl
* Montag, 4. April 2011 14:35 Uhr MESZ
*/

abstract public class NumberSeqHelper
{
  private static String  _id = "IDL:math/Statistics/NumberSeq:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (math.StatisticsPackage.NumberSeqHelper.id (), "NumberSeq", __typeCode);
    }
    return __typeCode;
  }
